import { createDownloadLinks, createImageLinks, decodeEntities } from '#common/helpers'
...
export const createSongPayload = (song: z.infer<typeof SongAPIResponseModel>): z.infer<typeof SongModel> => ({
  ...
  label: decodeEntities(song.more_info?.label || null),
  ...
  url: song.perma_url,
  copyright: decodeEntities(song.more_info?.copyright_text || null),
  album: {
    id: song.more_info?.album_id || null,
    name: decodeEntities(song.more_info?.album || null),
